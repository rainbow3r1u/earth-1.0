...
> **新会话/新AGENT入口**: ①读本文件(宪法§0.5+铁律§5) → ②读最新交接 **`docs/交接总结-20260912-Bug审计与口径修正.md`**(修复侧: 29条Bug修复+口径修正+影子账面回刷+2×2对照) 与 **`docs/交接总结-20260912-Regime-IC-MAE融合管道.md`**(采集侧: regime-IC/MAE静默管道) → ③触发词技能见§8.1后SKILL清单/交接总结§四。换电脑: clone本仓库即得全部知识(自包含)。
