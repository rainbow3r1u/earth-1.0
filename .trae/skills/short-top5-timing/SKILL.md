...
- **含费盈亏平衡线 = 34.4%** (2026-09-12 修正: 原写"33.3%(TP10/SL5赔率2:1)"是**理想化**数字, 未计手续费与滑点 → 偏低约1.2pp, 会让"33~34.4%"这段被误读成"还没到危险线")。
  口径与 `hybrid_tracker.settle_hybrid` 同一费用模型: 赢 = +10% −0.12%(taker×2) −0.02%(出场滑点) = **+9.86%**; 亏 = −5% −0.12% −0.05%(止损滑点) = **−5.17%**; 平衡胜率 = 5.17/(5.17+9.86) = **34.40%**。**未计 funding** —— 空头在挤压行情还要倒付, 故真实线只高不低。
  实证印证(2026-09-12, 全样本203笔): 止盈均 **+29.50U** / 止损均 **−15.59U** → 实证平衡线 **34.6%**, 与理论值互相印证。
- 分阶段: 8月上半脉冲市 38%/日均+12.6U | 放量潮期(8/19-22) 35%/日均-1.2U | **8/23后存量市 32%/日均-4.8U ← 卡在盈亏线下**
- **2026-09-12 更新读数**: 全程(8/3起) 203笔 胜率 **34.5%**(止盈70/止损117/到期16), 净 **+331.3U**, 每笔 **+1.63U**; 近10日 48笔 胜率 **37.5%**, 每笔 +1.95U
  → 全程只是**刚好压过**含费平衡线 34.4%(且未计funding税), 靠"到期"档(16笔均+5.6U)把净值拉正

**判定规则 (固定, 不临场发挥)**:
```
试盘绿灯 🟢: 近10日TOP5滚动胜率 ≥ 40% 且 资金面=放量潮期(山寨资金SKILL口径: 放量币>150/总额>75亿) 或 BTC破位(<77.3k, 以最新结构低点为准)
试盘黄灯 🟡: 近10日滚动胜率 34.4~40% (线上但无资金面配合 — 观察)
试盘红灯 🔴: 近10日滚动胜率 < 34.4% (含费盈亏线下 — 不试, 当前默认状态)
```
...
- 停止线: 试盘累计 -20U 或 滚动胜率跌回**含费平衡线34.4%**以下 → 停, 回影子臂积累
